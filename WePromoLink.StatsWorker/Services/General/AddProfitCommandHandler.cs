...
public class AddProfitCommandHandler : ChartDataRepository<string, decimal>, IProcessEvent<AddProfitCommand>
{
    private const int MAX_ITEMS = 20;

    public AddProfitCommandHandler(IMongoClient client) : base(StatisticsEnum.Profit, client)
    {
    }

    public async Task<bool> Process(AddProfitCommand item)
    {
        try
        {
